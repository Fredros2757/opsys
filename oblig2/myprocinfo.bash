...
case $valg in
     ...
     2)
	  ...
	  current=$(date +%s)
	  bootcheck=$(grep btime /proc/stat | awk '{print $2}')
     ...
     3)
	  ...
	  ;;
     4)
	  ctxtswitch1=$(grep ctxt /proc/stat | awk '{print $2}')
          sleep 1
	  ctxtswitch2=$(grep ctxt /proc/stat | awk '{print $2}')
	  ctxtdiff=$(("$ctxtswitch2" - "$ctxtswitch1"))
          echo "Antall context switcher i siste sekund var: "
	  echo "$ctxtdiff"
          ;;
     5)
	  usertid1=$(grep -w cpu /proc/stat | awk '{print $2}')
	  kerneltid1=$(grep -w cpu /proc/stat | awk '{print $4}')

	  sleep 1

	  usertid2=$(grep -w cpu /proc/stat| awk '{print $2}')
          kerneltid2=$(grep -w cpu /proc/stat | awk '{print $4}')
	  ...
	  ;;
     6)
	  interrupt1=$(grep intr /proc/stat | awk '{print $2}')
          sleep 1
          interrupt2=$(grep intr /proc/stat | awk '{print $2}')
